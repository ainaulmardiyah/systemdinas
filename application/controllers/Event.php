...
class Event extends CI_Controller {
	...
	{
		$agendaall = $this->agenda->gettoday();
		$agendaallpm = $this->agenda->gettomorowpm();
		$agenda = $this->agenda->gettomorow();
		$agendapm = $this->agenda->gettomorowpm();
		...
		$data = array(
				...
				'agendapm' => $agendapm->result(),
				'agendaallpm' => $agendaallpm->result(),
