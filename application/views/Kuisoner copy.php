...
<body >
 ...
 <div class="navbar navbar-default navbar-inverse" role="navigation" style="margin-right:300px;margin-left:80px;background: white;color:white;border:1;border-color:white">
          <div class="navbar-header">

              <button type="button" class="navbar-toggle" style="background-color:#11cdef;color:white;color:white;border:1;border-color:white">
              ...
              <div class="navbar-collapse">
                  ...
                  <li class="nav-item">
       <a class="nav-link" href="<?=site_url('allgrafik');?>" style="background-color:#11cdef;color:white">Grafik Staf<span class="sr-only"></span></a>
      </li>	
  <?php
  ...
  <li class="nav-item">
       ...
       <a class="nav-link" href="<?=site_url('rankingbidang');?>" style="background-color:#11cdef;color:white">Ranking Karyawan <span class="sr-only"></span></a>
      </li>	
      <?php
   }
   ?>
      ...
      <li class="nav-item">
       <a class="nav-link" href="<?=site_url('cuti');?>" style="background-color:#11cdef;color:white">Email Cuti<span class="sr-only"></span></a>
      </li>	
   <li class="nav-item">
      ...
      <li class="nav-item">
       <a class="nav-link" href="<?=site_url('ranking/answerdetailstaf');?>" style="background-color:#11cdef;color:white">Status Kompetensi<span class="sr-only"></span></a>
      </li>
 <li class="nav-item">
