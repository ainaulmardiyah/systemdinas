...
</style><?php echo form_open('Pertanyaan/prosesadd'); ?>
<div style="margin-bottom: 20px;">

</div>

<div class="page_title">
                           <center><u><br><h3><font  color="">Tambah Pertanyyaan Kuisoner</font> </h3><br></u></center>
...
<?php } ?>  
        ...
        <tr>
			...
			<td>
				...
				<input class="form-control" name="desc_pertanyaan" type="text">
			</td>
		</tr>
            <tr>
			...
			<td>
				...
				<input class="form-control" name="bobot_pertanyaan" type="number" step="0.00001">
			</td>
		</tr>
