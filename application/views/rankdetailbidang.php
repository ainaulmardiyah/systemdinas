...
<table id="example"  class="table table-bordered" style="width:100%">
        <thead>
            <tr>
			<th><font color="white"><b>nilai_log_entropy</font></b></th>
                <th><font color="white"><b>nama_aspek</font></b></th>
                <th><font color="white"><b>prediksi_aspek</font></b></th>
   ...
   $sss=1;
	foreach ($ranks as $b => $row) { 
      ...
      <tr>
                ...
                <td><font color="white"><?=$entropylog?></font></td>
                <td><font color="white"><?=$row->nama_aspek?></font></td>
                <td><font color="white"><?=$row->prediksi_aspek?></font></td>
...
?>	
<br>
 <tr ><font color='yellow'><b>Entopry Total : <?=$sss?><b></font> <tr>
        </tbody>
     
    </table>
    <a href="<?=site_url('rankingbidang');?>"><button class="btn btn-info" type="button">Kembali</button></a>
    ...
    $(document).ready(function(){
        ...
        $('.btn-detail').on('click',function(){
          const id = $(this).data('id');
            ...
            window.location.replace("https://quesioner.my.id/dinas/rankingbidang/answerdetail/"+id);
