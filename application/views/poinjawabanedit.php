...
<div class="page_title">
                           <center><u><br><h3><font  color="">Tambah Poin jawaban Kerja Dinas</font> </h3><br></u></center>
...
<?php } ?>  
			...
			<option value="<?=$row->id_pertanyaan?> " <?php if($poinjwb[0]->id_pertanyaan_jwb == $row->id_pertanyaan) echo "selected"; ?>> <?=$row->desc_pertanyaan;?></option>
			...
			<td>
			<input class="form-control" value="<?=$poinjwb[0]->id_poinjwb?>" name="id_edit" type="hidden">
			
				<input class="form-control" value="<?=$poinjwb[0]->desc?>" name="desc" type="text">
			</td>
		</tr>
        <tr>
			<td>Bobot Jawaban</td>
			...
			<td>
				...
				<input class="form-control" value="<?=$poinjwb[0]->poin?>" name="poin" type="text">
			</td>
		</tr>
		<tr>
			<td>
    ...
    <?php
       foreach ($pertanyaanshow as $b => $row) { ?>
       
       <?=$row->desc_pertanyaan?><br><br>
    ...
    <div style="color:white;background:linear-gradient(to right, #1d86df 0%, #39b49a 100%);">
     <?php
       foreach ($jawabanshow as $b => $row) { ?>
       <tr>
       <td><?=$row->desc?><td> <td><b><font color="yellow"><?=$row->poin?></b></font></td><br>
       </tr>
       <?php
       }
       ?>
